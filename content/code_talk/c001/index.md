+++
date = '2026-01-30T19:36:06+08:00'
draft = false
title = '[码上杂谈][001期]一道笔试题竟如此离谱！'
+++
### 一、起因
...
下面这段代码的输出结果是什么？
##### 代码
![1.png](https://s2.loli.net/2025/02/15/e5ZIlU7w1TRamxi.png)
...
### 四、提示
- 我们将这道题目的代码稍微修改一下
- ![2.png](https://s2.loli.net/2025/02/15/z25KWc3sH6xFOgI.png)
- 这样修改以后输出结果依然不变
...
- 接下来我们来写一个小例子
- ![4.png](https://s2.loli.net/2025/02/15/2J75H1Q9fqGedW6.png)
- 这个例子的输出结果是
    ```
    giao2
    ```
...
- 我们再对代码进行两次改动
- ![5.png](https://s2.loli.net/2025/02/15/UAiEBSpdVngs7Dx.png)
- ![6.png](https://s2.loli.net/2025/02/15/EtDIeOvsBPKmM7r.png)
- 在这两次改动后输出结果分别为
    ```
    //第一次输出结果
    parent
...
- ![7.png](https://s2.loli.net/2025/02/15/ODdkiZzCMU1R63r.png)
- 这段代码的执行结果为0，证明了子类对象在父类构造方法还没执行完的时候是不存在的。
- 因为子类对象还没创建出来，所以子类对象的属性也就不存在了，所以使用this修饰的属性是null。
- 至此，这道“简短”的面试题也就解析完了，真的是有点小复杂。

### 六、难点
- ![3.png](https://s2.loli.net/2025/02/15/d8k67cq5eJvWSKQ.png)
- ![8.png](https://s2.loli.net/2025/02/15/Z1cfogCOqbpTeds.png)
  
### 七、看代码
- 题目代码：[查看](https://github.com/tyza66/RandomMeasurement/blob/main/Java/src/main/java/org/example/ParentClassSubclassWhoComesFirstAndWhoComesLater.java)
- 验证重写执行代码：[查看](https://github.com/tyza66/RandomMeasurement/blob/main/Java/src/main/java/org/example/ParentClassConstructionWillExecuteMethodsOverriddenInSubclasses.java)
- 验证实例化顺序代码：[查看](https://github.com/tyza66/RandomMeasurement/blob/main/Java/src/main/java/org/example/DoSubclassObjectsExist.java)
